"""
    @module enhancement_renderer
    @class EnhancementRenderer
"""
from changelog_generator.main import EntryRenderer


class EnhancementRenderer(EntryRenderer):
    """
        The class controls the rendering of a enhancement
        entry in the changelog
    """
    def __init__(self, entry_obj):
        super(EnhancementRenderer, self).__init__(entry_obj)
        self._name = "EnhancementRenderer"
        self._description = "Class for rendering enhancements information in changelog"
